      ...
      <section className="w-full relative lg:py-16 bg-white">
        <div className="max-w-full xl:px-4 lg:px-4 md:px-3 px-4 mx-auto py-8">
          <div className="group/mainBox w-full flex flex-col lg:flex-row gap-6 items-start">
            <div className="lg:w-3/5 w-full grow flex flex-col justify-center lg:mt-6 mt-4">
              ...
              <div className="spaces mt-6 flex flex-row flex-wrap -mx-4">

                <div className="spaceCard lg:w-1/3 md:w-1/2 group-has-[.map]/mainBox:lg:w-1/2 group-has-[.map]/mainBox:md:w-full w-full p-4">
            ...
            <div className="map lg:w-2/5 w-full flex flex-col md:sticky md:top-10">
