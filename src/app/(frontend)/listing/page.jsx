        ...
        <div className="w-full flex flex-col lg:flex-row gap-6 items-start">
            <div className="lg:w-3/5 w-full grow flex flex-col justify-center">
              <div className='form-group filter-group'>
                ...
                <div className='scrollmenu overflow-auto whitespace-nowrap py-4 mb-4'>
                ...
                <div className='filter-row w-full flex flex-nowrap items-center gap-4'>
                      ...
                      <div>
                        <nav className='block '>
                          <ul className='flex'>
                            <li className='text-[13px] !leading-8 font-normal list-style-none'>
                              <a href='' className='flex items-center cursor-pointer font-medium text-[#777777] text-sm'>
                                <svg className='text-[#777777] size-[15px] me-1' stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg"><path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z"></path></svg>
                                Location
                              </a>
                            </li>
                          </ul>       
                  ...
                  <div className='lg:w-2/5 w-full items-center flex justify-end'>
                    <div className="text-right xs:text-left">
                      <p className="text-sm text-gray-700 leading-10 text-[15px]">
              ...
              <div className="tab-content w-full flex flex-col items-center gap-6 mt-6">
                <div id="grid-view" className='tab-pane active product-grid grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4'>
                    <div className='flex flex-col bg-white duration-500 rounded-[3px] relative shadow-[0_0_17px_0_rgba(0_0_0_0.1)] mb-[30px]'>
                      <div className='relative overflow-hidden rounded-t-[3px] h-full'></div>
                    </div>
                </div>
              </div>
            </div>

            <div className="lg:w-2/5 w-full flex flex-col ps-8">
