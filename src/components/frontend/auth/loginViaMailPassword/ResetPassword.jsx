...
const ResetPassword = ({ setIsOpen, email, resetPasswordOtp }) => {
  ...
  const { mutate: submitPasswordMutation, isPending } = useMutation({
    mutationFn: async (payload) => {
      const response = await postAPI("user/forgotPasswordVerifyOtp", payload);
  ...
  const onSubmit = async (values) => {
    const payload = {
      ...
      reset_password_code: resetPasswordOtp,
    };
