      ...
      <div className="container mx-auto pt-[50px] pb-13">
        <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-3 ">
          <ul className="space-y-[10px] px-[15px]">
            <li className="relative w-fit before:absolute before:left-0 before:top-full before:h-[1px] before:w-0 before:bg-[#555] before:opacity-0 before:transition-[width,opacity] before:duration-300 hover:before:w-full hover:before:opacity-100 text-[#555]">
              <Link
                href="/enterprise"
            ...
            <li className="relative w-fit before:absolute before:left-0 before:top-full before:h-[1px] before:w-0 before:bg-[#555] before:opacity-0 before:transition-[width,opacity] before:duration-300 hover:before:w-full hover:before:opacity-100 text-[#555] sm:pb-0 pb-2">
          ...
          <ul className="space-y-[10px] px-[15px]">
            <li className="relative before:absolute before:left-0 before:top-full before:h-[1px] before:w-0 before:bg-[#555] before:opacity-0 before:transition-[width,opacity] before:duration-300 hover:before:w-full hover:before:opacity-100 text-[#555]">
              <Link
