    ...
    <>
            ...
            <div className="flex flex-wrap mx-[-15px] justify-end">
              <div className="lg:w-10/12 md:w-10/12 px-[15px] w-full">
                <div className="w-full relative flex flex-col items-start text-white">
                  <h1 className="w-full lg:text-4xl md:text-[17px] lg:!leading-[1.6] text-white font-medium mb-4">
                    List Your Space and Grow Your Earnings
                  </h1>
                  <ul className="flex flex-col text-start md:pl-4 pl-2 ">
                    <li className="lg:mb-4 md:mb-4 mb-2 gap-2 flex items-center text-white lg:text-[21px] text-base">
                      <span>
                        <Svg name="check" className="size-[24px] text-white" />
                      </span>
          ...
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-5/12 md:w-5/12 w-full flex flex-col">
              <div className="lg:relative lg:z-10 p-3 shadow-[0_0_3px_#bababa] bg-white rounded-md lg:-ml-16 border-2 border-dashed border-[#f76900] lg:mt-0 mt-6">
                <h2 className="font-normal text-2xl/10">
                  Join India's Premier Space Marketplace!{" "}
                </h2>
                <p className="text-sm/normal min-[1400px]:text-base font-normal text-[#777]">
                  Join hundreds of hosts with 1,800+ listings from 20+ cities
                  across India and start monetizing your space today. Whether
                  you have a coworking space, office for lease, meeting room,
                  studio, event venue or activity space, Flexo helps you connect
                  with businesses and professionals actively looking for the
                  perfect workspace.{" "}
                </p>
              </div>
            </div>
          ...
          <div className="flex lg:flex-row flex-col h-full lg:gap-x-[30px] lg:pt-8 pt-6">
            <div className="lg:w-1/3 relative p-6 flex flex-col shadow-[0_0_3px_#8b8b8b] rounded-md overflow-hidden h-auto lg:mb-0 mb-6 before:absolute before:left-[-1px] before:top-[-1px] before:h-[48px] before:border-[3px] before:border-[#f76900] before:rounded-[30px] after:absolute after:right-[-1px] after:bottom-[-1px] after:h-[48px] after:border-[3px] after:border-[#f76900] after:rounded-[30px]  transition-all duration-500 md:hover:-translate-y-[10px]">
              <div className="count mb-2">
                <span className="rounded-full bg-white shadow-[0_0_3px_#f76900] w-10 h-10 flex justify-center items-center text-[18px] font-medium text-[#f76900] border-2 border-[#f76900]">
                  01
                </span>
              </div>
              <h5 className="text-base/relaxed min-[1400px]:text-lg text-[#f76900] font-medium">
                Sign Up and Create Your Listing
              </h5>
              <p className="text-[#777] text-sm/normal min-[1400px]:text-base">
                Provide key details like location, size, amenities, and usage
                categories. Upload high-quality photos to showcase your space.
              </p>
            </div>
            <div className="lg:w-1/3 relative p-6 flex flex-col shadow-[0_0_3px_#8b8b8b] rounded-md overflow-hidden h-auto lg:mb-0 mb-6 before:absolute before:left-[-1px] before:top-[-1px] before:h-[48px] before:border-[3px] before:border-[#f76900] before:rounded-[30px] after:absolute after:right-[-1px] after:bottom-[-1px] after:h-[48px] after:border-[3px] after:border-[#f76900] after:rounded-[30px] transition-all duration-500 md:hover:-translate-y-[10px]">
              <div className="count mb-2">
              ...
              <p className="text-[#777] text-sm/normal min-[1400px]:text-base">
                Choose how you want to rent your space and set your pricing.
                Offer hourly, daily, or long-term leases based on what works
            ...
            <div className="lg:w-1/3 relative p-6 flex flex-col shadow-[0_0_3px_#8b8b8b] rounded-md overflow-hidden h-auto lg:mb-0 mb-6 before:absolute before:left-[-1px] before:top-[-1px] before:h-[48px] before:border-[3px] before:border-[#f76900] before:rounded-[30px] after:absolute after:right-[-1px] after:bottom-[-1px] after:h-[48px] after:border-[3px] after:border-[#f76900] after:rounded-[30px] transition-all duration-500 md:hover:-translate-y-[10px]">
              ...
              <p className="text-[#777] text-sm/normal min-[1400px]:text-base">
                Go live on the platform, receive inquiries and bookings, and
                effortlessly manage everything from your dashboard.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="w-full relative py-10">
        <div className="container mx-auto px-[15px]">
          ...
          <p className="text-sm/normal min-[1400px]:text-base text-[#777777] text-center mx-auto">
            From vibrant coworking spaces, sleek offices to creative studios,
            every space has a home on Flexo. We bring together diverse spaces
            for work, creativity, activities, and collaboration—all in one
            marketplace.
          </p>
                  ...
                  >
                    <div className="h-[350px] shadow-[0_0_3px_#cfcfcf] rounded-md relative m-3 transition-all duration-300 overflow-hidden">
                      ...
                      <div className="text-center p-3">
                        <h5 className="text-base/relaxed font-medium text-[#f76900]">
                          {space.title}
                        </h5>
                        <p className="text-sm text-[#777777]">{space.desc}</p>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="container mx-auto px-[15px]">
          ...
          <div className="grid lg:grid-cols-4 grid-cols-1 gap-[30px] lg:pt-8 pt-6">
            <div className="relative p-6 shadow-[0_0_3px_#8b8b8b] bg-[#f76900] rounded-md overflow-hidden h-full after:absolute after:left-0 after:w-0 after:bottom-0 after:border-[#ffffff] after:border-2 after:rounded-[30px] md:hover:after:w-full after:duration-500 after:transition-all md:hover:-translate-y-[10px] transition-all duration-500 group">
              <div className="mb-12">
                <h5 className="text-white font-semibold mb-1 min-[1400px]:text-lg text-base">
                  Reach The Right Audience
                </h5>
                <p className="text-sm text-white min-[1400px]:text-base ">
                  Tap into a large user base actively searching for spaces like
                  yours.
                </p>
              </div>
              <div className="listCount">
                <span className="text-[60px] font-medium text-white absolute bottom-[-19px] opacity-20 right-[13px] transition-all duration-500 group-hover:opacity-100 group-hover:text-[40px] group-hover:bottom-0">
                  01
                </span>
              </div>
            </div>
            ...
            <div className="relative p-6 shadow-[0_0_3px_#8b8b8b] bg-[#f76900] rounded-md overflow-hidden h-full after:absolute after:left-0 after:w-0 after:bottom-0 after:border-[#ffffff] after:border-2 after:rounded-[30px] md:hover:after:w-full after:duration-500 after:transition-all md:hover:-translate-y-[10px] transition-all duration-500 group">
              <div className="mb-12">
                ...
                <p className="text-sm text-white min-[1400px]:text-base ">
                  List spaces for coworking, meetings, shoots, events, or
                  short-term bookings.
                </p>
              </div>
              <div className="listCount">
            ...
            <div className="relative p-6 shadow-[0_0_3px_#8b8b8b] bg-[#f76900] rounded-md overflow-hidden h-full after:absolute after:left-0 after:w-0 after:bottom-0 after:border-[#ffffff] after:border-2 after:rounded-[30px] md:hover:after:w-full after:duration-500 after:transition-all md:hover:-translate-y-[10px] transition-all duration-500 group">
              <div className="mb-12">
                ...
                <p className="text-sm text-white min-[1400px]:text-base ">
                  Control pricing, availability, and usage types to optimize
                  your revenue.
                </p>
              </div>
              <div className="listCount">
            ...
            <div className="relative p-6 shadow-[0_0_3px_#8b8b8b] bg-[#f76900] rounded-md overflow-hidden h-full after:absolute after:left-0 after:w-0 after:bottom-0 after:border-[#ffffff] after:border-2 after:rounded-[30px] md:hover:after:w-full after:duration-500 after:transition-all md:hover:-translate-y-[10px] transition-all duration-500 group">
              <div className="mb-12">
                ...
                <p className="text-sm text-white min-[1400px]:text-base ">
                  From onboarding to managing bookings, we’ve got you covered.
                </p>
              </div>
              <div className="listCount">
                <span className="text-[60px] font-medium text-white absolute bottom-[-19px] opacity-20 right-[13px] transition-all duration-500 group-hover:opacity-100 group-hover:text-[40px] group-hover:bottom-0">
            ...
            <div>
              ...
              >
                {person.map((person, index) => (
                  <div
                    key={index}
                    className="embla__slide relative h-full shrink-0 basis-full mt-[10px] px-[15px] "
                  >
      ...
      <section className="relative w-full py-15 lg:h-[400px] h-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative container z-10 text-center px-[15px] py-3">
          ...
          <Link
            href={`${HOST_BASE_URL}/auth/register`}
            target="_blank"
            className="inline-block bg-[#f76900] mt-6 tracking-[1px] min-[1400px]:text-base  text-[15px] border border-[#f76900] hover:border-white hover:bg-[#ff7c52] text-white md:px-7.5 px-5 md:py-[15px] py-[10px] rounded-[6px] font-semibold duration-500 transition uppercase"
          >
            List Your Space Now
          </Link>
        </div>
