...
const TrustedCompaniesCta = ({ setIsOpen, type }) => {
  const companies = [
    {
      src: "/images/trusted-logo7.webp",
      alt: "Amethyst partners",
      title: "Amethyst partners",
    },
    {
      src: "/images/trusted-logo6.webp",
      alt: "Accord Synergy",
      title: "Accord Synergy",
    },
    {
      src: "/images/trusted-logo13.webp",
      alt: "Arvind Mafatlal Group",
      title: "Arvind Mafatlal Group",
    },
    {
      src: "/images/trusted-logo14.webp",
      alt: "Beer biceps",
      title: "Beer biceps",
    },
    ...
    {
      src: "/images/trusted-logo16.webp",
      alt: "Mirae Asset Financial Service",
      title: "Mirae Asset Financial Service",
    },
    { src: "/images/trusted-logo4.webp", alt: "No broker", title: "No broker" },
    {
      src: "/images/trusted-logo1.webp",
      alt: "Financial Aggregations",
      title: "Financial Aggregations",
    },
    ...
    {
      src: "/images/trusted-logo5.webp",
      alt: "Scentido niche perfumery",
      title: "Scentido niche perfumery",
    },
    { src: "/images/trusted-logo8.webp", alt: "Shop 101", title: "Shop 101" },
    { src: "/images/trusted-logo19.webp", alt: "Sterimax", title: "Sterimax" },
    {
      src: "/images/trusted-logo9.webp",
      alt: "Thyssenkrupp",
      title: "Thyssenkrupp",
    },
    ...
    <section className="w-full relative ">
      <div className="relative lg:py-5.5 py-7 px-6 rounded-2xl items-center shadow-[0_4px_10px_#00000014] mx-auto overflow-hidden bg-[#f76900]">
        ...
        <div className="container mx-auto text-center px-[15px] relative z-10">
          ...
          <EmblaCarousel
            options={{ loop: true, autoscroll: true, align: "start" }}
          >
            {companies.map((s, i) => (
              <div
                key={i}
          ...
          <p className="text-white lg:text-base text-sm lg:mb-8 my-4">
            Over{" "}
            <span className="font-semibold">250+ enterprises and startups</span>{" "}
            found their perfect office with Flexo.
          </p>
