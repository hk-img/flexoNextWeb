        ...
        <div className="max-w:[1224px] w-[92%] mx-auto px-[12px]">
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-[15px]">
              ...
              <div>
                <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">The terms "Flexo", "Company", "we", "us" and "our" refer to the Flexo Spaces.</p>
                <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">
                ...
                <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">
                The term "Services" refers to any services offered by Flexo Spaces whether on the Swiggy Platform or otherwise. <br /> The term "Policy" refers to this Privacy Policy.
                </p>
                <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">
            ...
            <div className="flex flex-col ">
              ...
              <ul className="flex flex-col gap-2 leading-[30px] text-[13px] pl-12 text-[#777] list-disc font-normal">
            ...
            <div className="flex flex-col gap-[15px]">
              ...
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">By using the Flexo Spaces Platform and the Services provided therein, you agree and consent to the collection, transfer, use, storage, disclosure and sharing of your information as described and collected by us in accordance with this Policy. If you do not agree with the Policy, please do not use or access the Flexo Spaces Platform.</p>
            </div>
            <div className="flex flex-col ">
              <h3 className="text-[#000e54] text-lg underline font-semibold mb-[15px]">
                COOKIES:
              </h3>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">Our Flexo Spaces Platform and third parties with whom we partner, may use cookies, pixel tags, web beacons, mobile device IDs, "flash cookies" and similar files or technologies to collect and store information with respect to your use of the Services and third-party websites. <br /> Cookies are small files that are stored on your browser or device by websites, apps, online media and advertisements. We use cookies and similar technologies for purposes such as:</p>
              <ul className="flex flex-col leading-[30px] pl-12 text-[#777] list-disc font-normal text-[13px]">
                <li>
              ...
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">A pixel tag (also called a web beacon or clear GIF) is a tiny graphic with a unique identifier, embedded invisibly on a webpage (or an online ad or email), and is used to count or track things like activity on a webpage or ad impressions or clicks, as well as to access cookies stored on users’ computers. We use pixel tags to measure the popularity of our various pages, features and services. We also may include web beacons in e-mail messages or newsletters to determine whether the message has been opened and for other analytics.</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">To modify your cookie settings, please visit your browser’s settings. By using our Services with your browser settings to accept cookies, you are consenting to our use of cookies in the manner described in this section.</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">We may also allow third parties to provide audience measurement and analytics services for us, to serve advertisements on our behalf across the Internet, and to track and report on the performance of those advertisements. These entities may use cookies, web beacons, SDKs and other technologies to identify your device when you visit the Flexo Spaces Platform and use our Services, as well as when you visit other online sites and services.</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">Please see our Cookie Policy here for more information regarding the use of cookies and other technologies described in this section, including regarding your choices relating to such technologies.</p>
            </div>
            <div className="flex flex-col">
              <h3 className="text-[#000e54] text-lg underline font-semibold mb-[15px]">
               DATA SECURITY PRECAUTIONS:
              </h3>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">We have in place appropriate technical and security measures to secure the information collected by us. We use vault and tokenization services from third party service providers to protect the sensitive personal information provided by you. The third-party service providers with respect to our vault and tokenization services and our payment gateway and payment processing are compliant with the payment card industry standard (generally referred to as PCI compliant service providers). You are advised not to send your full credit/debit card details through unencrypted electronic platforms. Where we have given you (or where you have chosen) a username and password which enables you to access certain parts of the Flexo Spaces Platform, you are responsible for keeping these details confidential. We ask you not to share your password with anyone.</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">Please be aware that the transmission of information via the internet is not completely secure. Although we will do our best to protect your personal data, we cannot guarantee the security of your data transmitted through the Flexo Spaces Platform. Once we have received your information, we will use strict physical, electronic, and procedural safeguards to try to prevent unauthorised access.</p>
            </div>
             <div className="flex flex-col gap-[15px]">
              <h3 className="text-[#000e54] text-lg underline font-semibold">
              EMAIL OPT-OUT:
              </h3>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">You can opt out of receiving our marketing emails. To stop receiving our promotional emails, please email <Link
                href="flexospaces.com"
                className="text-black hover:text-[#777]"
              >
            ...
            <div className="flex flex-col ">
              ...
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">The Flexo Spaces Platform may contain links to other websites. If you click on one of the links to third party websites, you may be taken to websites we do not control. Any personal information about you collected whilst visiting such websites is not governed by this Policy. Flexo Spaces shall not be responsible for and has no control over the practices and content of any website accessed using the links contained on the Flexo Spaces Platform. Read the privacy policy of other websites carefully as this policy does not apply to the privacy practices of those websites. We are not responsible for these third party sites.</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">This Policy shall also not apply to any information you may disclose to any of our service providers/service personnel which we do not require you to disclose to us or any of our service providers under this Policy.</p>
            </div>
             <div className="flex flex-col">
              <h3 className="text-[#000e54] text-lg underline font-semibold mb-[15px]">
                JURISDICTION:
              </h3>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">If you choose to visit the website, your visit and any dispute over privacy is subject to this Policy and the website's terms of use. In addition to the foregoing, any disputes arising under this Policy shall be governed by the laws of India</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">Further, please note that the Flexo Spaces Platform stores your data with the cloud platform of provided by Amazon Web Services, which may store this data on their servers and has security measures in place to protect the loss, misuse and alteration of the information, details of which are available on their website.</p>
              <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5] mb-2">In the event you have questions or concerns about the security measures adopted by Amazon Web Services, you can contact their data protection/ privacy team/ legal team or designated grievance officer at these organisations, whose contact details are available in its privacy policy, or can also write to our Grievance Officer at the address provided above.</p>
               <p className="text-sm 2xl:text-base text-[#777] font-normal leading-[1.5]">If you have any queries relating to the processing or usage of information provided by you in connection with this Policy or other privacy concerns, you can email us at <Link
                href="flexospaces.com"
                className="text-black hover:text-[#777]"
              >
                 hello@flexospaces.com.
